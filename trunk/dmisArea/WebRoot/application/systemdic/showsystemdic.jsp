...
<jhop:grid 	id="mygrid"
      ...
      busName="SystemdicDto"
      subName="128209034753246248"
      pageItems="30"
      listType="3"
      listKind="101"
      entityName="Systemdic"
      isDisplaySet="0"
      isQuerySet="0"
      isPageSet="0"
      isOutputSet="0"
      isCheckBox="0" 
      queryPath="/systemdic.do?method=getSystemdic&typeId=${typeId}">
</jhop:grid>
	...
	<script>
		...
		*/
			...
			if(type != "cannel"){
				...
				if(rows){
					var nvalue=mygrid.getValByRC(rows[0],'name');
					var ncode = mygrid.getValByRC(rows[0],'classify_code');
					//alert(nvalue+"^"+ncode);
					window.returnValue 	= nvalue+"^"+ncode;
				}
			}
			window.close();
		}
