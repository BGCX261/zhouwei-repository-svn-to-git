 ...
 * @date
 */
public class ParaDCSysInfoDto  implements Serializable {
    
	public ParaDCSysInfoDto() {
    }
	      ...
	      private com.techstar.dmis.dto.EtsEquipmentDto zparadcsysinfo2; //设备ID
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparadcsysinfo2(com.techstar.dmis.dto.EtsEquipmentDto zparadcsysinfo2){
        this.zparadcsysinfo2=zparadcsysinfo2;
    }
	   public com.techstar.dmis.dto.EtsEquipmentDto getZparadcsysinfo2(){
