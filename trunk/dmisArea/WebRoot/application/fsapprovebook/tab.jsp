...
<!--
   	...
   	function onClick1(){
		document.all.iframe1.src = "<%=request.getContextPath()%>/application/fsapprovebook/grid.jsp";
	}
...
<jhop:labelgroup height="530" labelHead="发电批准书浏览,发电批准书详情" scroll="auto,auto"> </jhop:labelgroup>
