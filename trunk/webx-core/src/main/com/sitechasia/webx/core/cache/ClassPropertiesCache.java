/** 
 * @{#} ClassPropertiesCache.java Create on 2008-6-16 上午11:27:06   
 *   
...
public class ClassPropertiesCache {
	...
	public static synchronized ClassPropertiesCache getInstance() {
		if (instance == null)
			instance = new ClassPropertiesCache();
		return instance;
	}
	...
	public Object transportPropertyValue(Class<?> entity, String property, String value) {
		...
		if (propType.equals(char.class) || propType.equals(Character.class))
	...
	public boolean checkToken(CacheToken token) {
		...
		if (propType == null) {
			...
			if(propType.equals(int.class) && valueClass.equals(Integer.class))
				return true;
			if(propType.equals(float.class) && valueClass.equals(Float.class))
				return true;
			if(propType.equals(double.class) && valueClass.equals(Double.class))
				return true;
			if(propType.equals(byte.class) && valueClass.equals(Byte.class))
				return true;
			if(propType.equals(short.class) && valueClass.equals(Short.class))
				return true;
			if(propType.equals(long.class) && valueClass.equals(Long.class))
				return true;
			if(propType.equals(char.class) && valueClass.equals(Character.class))
				return true;
			if(propType.equals(boolean.class) && valueClass.equals(Boolean.class))
				return true;
			return false;
		} else {
			return true;
	...
	class PropertyInfo {
		...
		public Class<? extends Object> type; // 属性类型
	}
