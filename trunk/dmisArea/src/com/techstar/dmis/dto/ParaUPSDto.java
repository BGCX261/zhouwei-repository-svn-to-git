 ...
 * @date
 */
public class ParaUPSDto  implements Serializable {
	...
	public ParaUPSDto() {
	      ...
	      private com.techstar.dmis.dto.EtsEquipmentDto zparaups2; //设备ID
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparaups2(com.techstar.dmis.dto.EtsEquipmentDto zparaups2){
        this.zparaups2=zparaups2;
    }
	   public com.techstar.dmis.dto.EtsEquipmentDto getZparaups2(){
      return zparaups2;
    }
