 ...
 * @date
 */
public class ParaHISwitchDto  implements Serializable {
    
	public ParaHISwitchDto() {
    }
	      ...
	      private com.techstar.dmis.dto.EtsEquipmentDto zparahiswitch2; //设备ID
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparahiswitch2(com.techstar.dmis.dto.EtsEquipmentDto zparahiswitch2){
        this.zparahiswitch2=zparahiswitch2;
    }
	   public com.techstar.dmis.dto.EtsEquipmentDto getZparahiswitch2(){
      return zparahiswitch2;
    }
