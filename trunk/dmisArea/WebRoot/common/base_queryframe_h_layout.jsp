...
<FRAMESET rows="32,*" cols="*" framespacing="0" frameborder="no" border="0" id="msg_up_down">
	<FRAME name="upFrame"	src="<%=request.getContextPath()%><%=UpFrame%>" scrolling="no" noresize >
