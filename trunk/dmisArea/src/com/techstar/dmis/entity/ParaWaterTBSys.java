 ...
 * @date
 */
public class ParaWaterTBSys implements Serializable {
    
	public ParaWaterTBSys() {
    }
    		 private int fctrlperiod;//控制周期s
					 ...
					 private com.techstar.dmis.entity.EtsEquipment zparawatertbsys2;
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparawatertbsys2(com.techstar.dmis.entity.EtsEquipment zparawatertbsys2){
        this.zparawatertbsys2=zparawatertbsys2;
    }
	   public com.techstar.dmis.entity.EtsEquipment getZparawatertbsys2(){
