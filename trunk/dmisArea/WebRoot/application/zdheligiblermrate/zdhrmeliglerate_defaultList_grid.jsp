...
<br>
<% 
	String url = "/zdhEligiblermrate.do?method=standGridQuery&extOrder reportsdate desc";
%>
<br>
<div id='mygrid'></div>
<br>
...
<jhop:grid 	id="mygrid"
      ...
      busName="ZdhEligiblermrateDto"
      subName="128201305916810800"
      pageItems="30"
      listType="3"
      listKind="101"
      entityName="ZdhEligiblermrate"
      isDisplaySet="1"
      isQuerySet="1"
      isPageSet="1"
      isOutputSet="1"
