 ...
 * @date
 */
public class DdEnsuringpsmanageDto  implements Serializable {
    
	public DdEnsuringpsmanageDto() {
    }
	      ...
	      private java.util.Collection fddpremethod4; //保电源单编号
		 

  	private DdEnsuringpsmanageWFTaskDto ddEnsuringpsmanageWFTaskDto;
	public DdEnsuringpsmanageWFTaskDto getDdEnsuringpsmanageWFTaskDto() {
		return ddEnsuringpsmanageWFTaskDto;
	}
	public void setDdEnsuringpsmanageWFTaskDto(DdEnsuringpsmanageWFTaskDto ddEnsuringpsmanageWFTaskDto) {
		this.ddEnsuringpsmanageWFTaskDto = ddEnsuringpsmanageWFTaskDto;
	}
