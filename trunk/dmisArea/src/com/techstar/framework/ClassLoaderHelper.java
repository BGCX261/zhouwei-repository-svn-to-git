...
public class ClassLoaderHelper {
     ...
     *@throwsMalformedURLException
     ...
     public static String getAbsolutePathOfClassLoaderClassPath(){
       // URL url = ClassLoaderHelper.getClassLoader().getResource("com/techstar/jhop/cms/engine/helper/ClassLoaderHelper.class");
    	 URL url = ClassLoaderHelper.getClassLoader().getResource("com/techstar/framework/ClassLoaderHelper.class");
//         com.techstar.jhop.cms.engine.helper.CodeHelper.printlnScreen("===========>dddd:" + url.toString());
   ...
   *@throwsMalformedURLException
   ...
   public static URL getExtendResource(String relativePath) throws MalformedURLException{
       ...
       // com.techstar.jhop.cms.engine.helper.CodeHelper.printlnScreen("传入的相对路径："+relativePath) ;
       //ClassLoaderHelper.log.info(Integer.valueOf(relativePath.indexOf("../"))) ;
       if(!relativePath.startsWith("../")){
...
//        com.techstar.jhop.cms.engine.helper.CodeHelper.printlnScreen(Integer.valueOf(""+relativePath.lastIndexOf("../"))) ;
      ...
      //  com.techstar.jhop.cms.engine.helper.CodeHelper.printlnScreen("绝对路径："+resourceAbsolutePath) ;
...
//	    com.techstar.jhop.cms.engine.helper.CodeHelper.printlnScreen("=============sssss=====>source:" + source);
...
//        com.techstar.jhop.cms.engine.helper.CodeHelper.printlnScreen("==================>source2:" + source);
   ...
   /**
    ...
    public static URL getResource(String resource){
    	// com.techstar.jhop.cms.engine.helper.CodeHelper.printlnScreen("传入的相对于classpath的路径："+resource) ;
...
//      ClassLoaderHelper.getExtendResource("../config.properties");
      ClassLoaderHelper.getExtendResource("../../vm/action.vm");
      // com.techstar.jhop.cms.engine.helper.CodeHelper.printlnScreen(ClassLoaderHelper.getClassLoader().getResource("config.properties").toString());
//       com.techstar.jhop.cms.engine.helper.CodeHelper.printlnScreen(ClassLoaderHelper.getExtendVmResource("../../vm/").toString());
  }
