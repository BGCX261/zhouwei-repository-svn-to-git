...
<html>
	...
	<body>
		...
		<jhop:grid id="mygrid" pageId="standGridPage"
			...
			pageItems="30" listType="1" listKind="108"
			entityName="Dayplancoopraterel" isDisplaySet="0" isQuerySet="0"
			isPageSet="1" isOutputSet="0" isCheckBox="0"
			queryPath="/ddDoutageplan.do?method=coopratereUnfinishedDayPlanGridQuery">
		</jhop:grid>
