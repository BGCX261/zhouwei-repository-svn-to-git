 ...
 * @date
 */
public class FsLoaddatalist implements Serializable {
    
	public FsLoaddatalist() {
    }
    		 private java.sql.Date facquisitiondate;//数据采集日期
					 ...
					 private com.techstar.dmis.entity.FsLfparalist zfsloaddatalist1;
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZfsloaddatalist1(com.techstar.dmis.entity.FsLfparalist zfsloaddatalist1){
        this.zfsloaddatalist1=zfsloaddatalist1;
    }
	   public com.techstar.dmis.entity.FsLfparalist getZfsloaddatalist1(){
