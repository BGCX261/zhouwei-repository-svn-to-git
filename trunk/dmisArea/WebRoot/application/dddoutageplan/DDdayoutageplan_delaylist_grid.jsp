...
<% 
	 ...
	 */
	  ...
	  String url = "/ddDoutageplan.do?method=delayGridQuery&parentid="+parentid;
	  String refcol = "zdddayplandelaylist1.fdayplanno^"+parentid;
	  String listkind = "104";
		String listtype ="2";
...
<%-- 创建弹出窗口，并传递参数 --%>
<jhop:grid 	id="mygrid"
      busName="DdDoutageplanDto3" 
      subName="128197173192617632" 
      pageItems="30" 
      listType="<%=listtype %>" 
      listKind="<%=listkind %>" 
      divHeight="150"  
      isCheckBox="0"  
      isTotalRow="0" 
      listBox="fdelaystoptime#5,fdelayapplyer#108^showapply,fdelayapprover#108^showapprove" 
      refColVal ="<%=refcol %>" 
      entityName="DdDayplandelaylist" 
      queryPath="<%=url %>">
</jhop:grid>
...
<script>
  ...
  function  showapply(){
     var  impo = new importDatasObj('/application/ggperson/GgPerson_show_grid.jsp',{'name':'fdelayapplyer'},'mygrid');  
	       impo.height = 500;
           impo.width = 600;
  ...
  //延期批准人
   ...
   function  showapprove(){
     var  impo = new importDatasObj('/application/ggperson/GgPerson_show_grid.jsp',{'name':'fdelayapprover'},'mygrid');  
	       impo.height = 500;
           impo.width = 600;
           impo.showImportDatas();
