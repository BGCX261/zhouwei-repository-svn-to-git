...
/**
 * Domain classe for 拉路限电记录 This classe is based on ValueObject Pattern
 * 
 * @author
 * @date
 */
public class DdCutofflistDto implements Serializable {

	public DdCutofflistDto() {
	}
	...
	private java.util.Collection fddcutoffdetaillist1; // 拉路限电记录ID
	...
	public void setFddcutoffdetaillist1(
			java.util.Collection fddcutoffdetaillist1) {
