...
<!--
   	...
   	function onClick1(){
		document.all.iframe1.src = "<%=request.getContextPath()%>/application/ddrepairrisklist/grid.jsp";
	}
...
<jhop:labelgroup height="530" labelHead="电网风险提示浏览,电网风险提示详情" scroll="auto,auto"> </jhop:labelgroup>
