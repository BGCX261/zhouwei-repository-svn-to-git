 ...
 * @date
 */
public class ParaRTU implements Serializable {
	...
	public ParaRTU() {
    		 ...
    		 private String fisasampling;//遥测量是否为交流采样
					 ...
					 private com.techstar.dmis.entity.EtsEquipment zparartu3;
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparartu3(com.techstar.dmis.entity.EtsEquipment zparartu3){
        this.zparartu3=zparartu3;
    }
	   public com.techstar.dmis.entity.EtsEquipment getZparartu3(){
      return zparartu3;
    }
