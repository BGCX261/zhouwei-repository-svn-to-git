...
//    this._fake.setNoHeader(true);
	...
	if (this.ftr){
		...
		for (var i=1; i<rows.length; i++){
			var tftr=new Array();
			for (var j=0; j<ind; j++){
				tftr[j]=rows[i].cells[j].innerHTML;
				rows[i].cells[j].innerHTML="";
				}
			this._fake.attachFooter(tftr);
		}
	}
    ...
    */
		...
		this.loadSizeFromCookie=function(name){
            ...
            /*
			var zname="createRowFromXMLTag";
            this["_bfs_"+zname]=this[zname];
			this[zname]=function(){
                    var r=this["_bfs_createRowFromXMLTag"].apply(this,arguments);
                    var x=r.cloneNode(true);
      ...
      if (this._elmnh){
       ...
       /*     this._fake["_bfs_"+zname]=this._fake[zname];
            this._fake[zname]=this[zname];*/

        /*    var zname="selectCell";
            this["_bfs_"+zname]=this[zname];
            this[zname]=function(){  alert(1);
                    this["_bfs_selectCell"].apply(this,arguments);
                    if (arguments[1]<ind){
                        arguments[1]=0;
                        return this._fake["selectCell"].apply(this,arguments);
                    }
                    else
                    return  this._fake["selectCell"].apply(this,arguments);
            }*/
