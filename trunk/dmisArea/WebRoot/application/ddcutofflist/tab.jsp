...
<!--
   	...
   	function onClick1(){
		document.all.iframe1.src = "<%=request.getContextPath()%>/application/ddcutofflist/grid.jsp";
	}
...
<jhop:labelgroup height="530" labelHead="拉路限电记录浏览,拉路限电记录详情" scroll="auto,auto"> </jhop:labelgroup>
