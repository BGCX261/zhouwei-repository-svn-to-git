...
<!--
   	...
   	function onClick1(){
		...
		document.all.iframe1.src = "<%=request.getContextPath()%>/application/zdhmachineworklist/zdhmachinehalllist_defaultList_grid.jsp";
	}
	...
	if(isCopy=="true"&&(mainId == null  || mainId == "undefined" || mainId == "" || mainId == "null"))
  	{
		...
		document.all.iframe2.src = "<%=request.getContextPath()%>/zdhMachineworklist.do?method=initDetail&mainId=" + primaryId + "&isCopy="+isCopy;
	}
   
//-->
</script>

<jhop:labelgroup height="530" labelHead="机房工作浏览,机房工作详情" scroll="auto,auto"> </jhop:labelgroup>
