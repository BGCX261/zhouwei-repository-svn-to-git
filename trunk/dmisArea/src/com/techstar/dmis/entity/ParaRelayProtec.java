 ...
 * @date
 */
public class ParaRelayProtec implements Serializable {
    
	public ParaRelayProtec() {
    }
    		 private String frununit;//运行维护单位
					 ...
					 private com.techstar.dmis.entity.EtsEquipment zpararelayprotec2;
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZpararelayprotec2(com.techstar.dmis.entity.EtsEquipment zpararelayprotec2){
        this.zpararelayprotec2=zpararelayprotec2;
    }
	   public com.techstar.dmis.entity.EtsEquipment getZpararelayprotec2(){
