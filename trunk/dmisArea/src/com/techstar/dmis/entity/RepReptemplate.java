 ...
 * @date
 */
public class RepReptemplate implements Serializable {
    
	public RepReptemplate() {
    }
    		 private String f_treeid;//分类ID
					 ...
					 private java.util.Collection freprepresult1;
	    			 private com.techstar.dmis.entity.RepResdata zrepreptemplate1;
   ...
   /**
     ...
     */
      ...
      return freprepresult1;
           ...
           public void setZrepreptemplate1(com.techstar.dmis.entity.RepResdata zrepreptemplate1){
        this.zrepreptemplate1=zrepreptemplate1;
    }
	   public com.techstar.dmis.entity.RepResdata getZrepreptemplate1(){
