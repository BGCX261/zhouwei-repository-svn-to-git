		 ...
		 <table class="detail" width="100%" height="100%" cellspacing="0" >
          ...
          <td height="23" class="tab_0" width="20%">
			   ...
			   <td height="23" class="tab_0" width="20%">
				...
				<% 
					ZdhTransrecordDto zdhTransrecordDto=(ZdhTransrecordDto)request.getAttribute("zdhTransrecordDto");
					OutputStream os =response.getOutputStream();
					if(zdhTransrecordDto.getAnnexsequence()!=null&&zdhTransrecordDto.getAnnexsequence().length>0)
					{
					
						
						os.write(zdhTransrecordDto.getAnnexsequence());
