 ...
 * @date
 */
public class ParaMainTRF implements Serializable {
	...
	public ParaMainTRF() {
    		 ...
    		 private String fcapacityratio;//容量比
					 ...
					 private com.techstar.dmis.entity.EtsEquipment zparamaintrf2;
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparamaintrf2(com.techstar.dmis.entity.EtsEquipment zparamaintrf2){
        this.zparamaintrf2=zparamaintrf2;
    }
	   public com.techstar.dmis.entity.EtsEquipment getZparamaintrf2(){
