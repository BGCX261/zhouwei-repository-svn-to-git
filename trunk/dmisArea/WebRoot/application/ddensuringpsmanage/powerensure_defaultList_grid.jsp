...
<%-- 创建弹出窗口，并传递参数 --%>
<jhop:grid 	id="standGrid"
      pageId="standGridPage"
      busName="DdEnsuringpsmanageDto"
      subName="128190326051957224"
      pageItems="30"
      listType="3"
      listKind="101"
      entityName="DdEnsuringpsmanage"
      isDisplaySet="1"
      isQuerySet="1"
      isPageSet="1"
      isOutputSet="1"
      queryPath="/ddEnsuringpsmanage.do?method=standGridQuery">
</jhop:grid>