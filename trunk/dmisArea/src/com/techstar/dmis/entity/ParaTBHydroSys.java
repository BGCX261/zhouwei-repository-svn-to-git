 ...
 * @date
 */
public class ParaTBHydroSys implements Serializable {
    
	public ParaTBHydroSys() {
    }
    		 private int fsysspdchgratio;//系统速度变动率%
					 ...
					 private com.techstar.dmis.entity.EtsEquipment zparatbhydrosys2;
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparatbhydrosys2(com.techstar.dmis.entity.EtsEquipment zparatbhydrosys2){
        this.zparatbhydrosys2=zparatbhydrosys2;
    }
	   public com.techstar.dmis.entity.EtsEquipment getZparatbhydrosys2(){
