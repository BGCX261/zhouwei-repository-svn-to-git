 ...
 * @date
 */
public class ParaGenerator implements Serializable {
    
	public ParaGenerator() {
    }
    		 private String fpowerplan;//电厂名称
					 ...
					 private com.techstar.dmis.entity.EtsEquipment zparagenerator2;
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparagenerator2(com.techstar.dmis.entity.EtsEquipment zparagenerator2){
        this.zparagenerator2=zparagenerator2;
    }
	   public com.techstar.dmis.entity.EtsEquipment getZparagenerator2(){
