 ...
 * @date
 */
public class FsApprovebook implements Serializable {
    
	public FsApprovebook() {
    }
    		 private String fapprovbookno;//正式编号
	    			 ...
	    			 private com.techstar.dmis.entity.BhAsregulate zfsapprovebook6;
   ...
   /**
     ...
     */
      ...
      return ffsallappendix1;
           ...
           public void setZfsapprovebook6(com.techstar.dmis.entity.BhAsregulate zfsapprovebook6){
        this.zfsapprovebook6=zfsapprovebook6;
    }
	   public com.techstar.dmis.entity.BhAsregulate getZfsapprovebook6(){
