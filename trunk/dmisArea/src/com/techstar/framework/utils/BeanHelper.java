...
public class BeanHelper {
    ...
    public static void copyBeanProperties(Object destObj, Object oriObj) {
        ...
        try {
        	...
        	TBeanUtils.copyProperties(destObj,
			        oriObj);
    ...
    public static void main (String[] args){
    	...
    	/*EntityBean1 entity1 = new EntityBean1();
    	EntityBean2 entity2 = new EntityBean2();
    	
    	entity2.setAddr("haidian");
    	entity2.setCity("beijing");
    	
    	entity1.setStr("yang");
    	entity1.setEntity2(entity2);
    	
    	
    	EntityBean1Dto dto = (EntityBean1Dto)mapBean(EntityBean1Dto.class,entity1);
    	System.out.println(dto.getEntity2().getCity());
    	
    	try {
			//System.out.println(BeanUtils.getNestedProperty(entity1, "entity2.city"));
