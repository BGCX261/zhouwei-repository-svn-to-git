...
<!--
   	...
   	function onClick1(){
		document.all.iframe1.src = "<%=request.getContextPath()%>/application/fslfparalist/grid.jsp";
	}
...
<jhop:labelgroup height="530" labelHead="低频减载装置参数的属性清单浏览,低频减载装置参数的属性清单详情" scroll="auto,auto"> </jhop:labelgroup>
