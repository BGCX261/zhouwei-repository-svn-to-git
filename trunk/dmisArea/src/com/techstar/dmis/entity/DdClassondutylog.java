 ...
 * @date
 */
public class DdClassondutylog implements Serializable {
    
	public DdClassondutylog() {
    }
    		 private java.sql.Timestamp fsuccessiontime;//值班开始时间
					 ...
					 private java.util.Collection fddpowerplantoperlog4;
	    			 private java.util.Collection fddoperationnotebook4;
	    			 private java.util.Collection fddsasusprecord3;
	    			 private java.util.Collection fddwaterheight3;
	    			 private java.util.Collection fddwaterproofplan2;
	    			 private java.util.Collection fddhloadrecord4;
	    			 private java.util.Collection fddpowerchangrecord4;
	    			 private java.util.Collection fddhpoweroperaterrd5;
