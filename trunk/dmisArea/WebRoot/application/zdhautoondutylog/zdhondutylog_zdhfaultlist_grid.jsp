...
<%
	...
	String strMainId="ondutulogid='"+mainId+"'";
	String url="/zdhFaultlist.do?method=extStandGridQuery&extWheres="+strMainId;
...
<jhop:grid 	id="mygrid"
      ...
      busName="ZdhFaultlistDto"
      subName="128201230948008768"
      pageItems="10"
      listType="3"
      listKind="101"
      entityName="ZdhFaultlist"
      isDisplaySet="1"
      isQuerySet="1"
      isPageSet="1"
      isOutputSet="1"
