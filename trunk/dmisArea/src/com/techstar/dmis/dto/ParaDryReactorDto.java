 ...
 * @date
 */
public class ParaDryReactorDto  implements Serializable {
    
	public ParaDryReactorDto() {
    }
	      ...
	      private com.techstar.dmis.dto.EtsEquipmentDto zparadryreactor2; //设备ID
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparadryreactor2(com.techstar.dmis.dto.EtsEquipmentDto zparadryreactor2){
        this.zparadryreactor2=zparadryreactor2;
    }
	   public com.techstar.dmis.dto.EtsEquipmentDto getZparadryreactor2(){
