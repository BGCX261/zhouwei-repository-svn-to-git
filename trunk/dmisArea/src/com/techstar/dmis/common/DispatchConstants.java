...
public class DispatchConstants {
	...
	public static String DdEnsuringpsmanage_WORKFLOW_AREA_STATUS_NEW = "1"; // 新建

	public static String DdEnsuringpsmanage_WORKFLOW_AREA_STATUS_MODIFY = "1m"; // 修改

	public static String DdEnsuringpsmanage_WORKFLOW_AREA_STATUS_COURSIGN = "2"; // 会签

	public static String DdEnsuringpsmanage_WORKFLOW_AREA_STATUS_APPROVE = "3"; // 审核

	public static String DdEnsuringpsmanage_WORKFLOW_AREA_STATUS_SENT = "4"; // 下发

	public static String DdEnsuringpsmanage_WORKFLOW_AREA_STATUS_EXEC = "5"; // 执行

	public static String DdEnsuringpsmanage_WORKFLOW_AREA_STATUS_KEEPON = "6"; // 归档

	public static String DdEnsuringpsmanage_WORKFLOW_AREA_STATUS_OVER = "-1"; // 结束
	...
	public static String DdDoutageplan_WORKFLOW_AREA_STATUS_APPROVE_TRANSIT_YES = "401"; // 市调审批通过

	public static String DdDoutageplan_WORKFLOW_AREA_STATUS_APPROVE_TRANSIT_NO = "402";// 市调审批驳回

	public static String DdDoutageplan_WORKFLOW_BOROUGH_STATUS_APPROVE_TRANSIT_YES = "403"; // 区调审批通过

	public static String DdDoutageplan_WORKFLOW_BOROUGH_STATUS_APPROVE_TRANSIT_NO = "404";// 区调审批驳回

	public static String DdDoutageplan_WORKFLOW_STATUS_NEW = "1"; // 新建

	public static String DdDoutageplan_WORKFLOW_STATUS_ARRAY = "2"; // 计划专工整理日计划

	public static String DdDoutageplan_WORKFLOW_STATUS_COURSIGN = "3"; // 会签

	public static String DdDoutageplan_WORKFLOW_STATUS_SENT = "4"; // 计划专工下发计划

	public static String DdDoutageplan_WORKFLOW_STATUS_EXEC = "5"; // 填写计划执行情况

	public static String DdDoutageplan_WORKFLOW_STATUS_KEEPON = "6"; // 区调计划专工归档

	public static String DdDoutageplan_WORKFLOW_STATUS_check = "7"; // 核准日计划

	public static String DdDoutageplan_WORKFLOW_STATUS_message = "8"; // 通知客户

	public static String DdDoutageplan_WORKFLOW_STATUS_OVER = "-1"; // 结束
	...
	public static String DdSwitchseqBill_WORKFLOW_AREA_STOP_YES_NUM = "302"; // 终止flag

	public static String DdSwitchseqBill_WORKFLOW_AREA_EXEC_YES_NUM = "301"; // 执行flag

	public static String DdSwitchseqBill_WORKFLOW_AREA_EXEC_NO_NUM = "303";// 驳回

	// flag

	// 操作票流程状态

	public static String DdSwitchseqBill_WORKFLOW_AREA_STATUS_NEW = "1";// 新建

	public static String DdSwitchseqBill_WORKFLOW_AREA_STATUS_MODIFY = "101"; // 修改

	public static String DdSwitchseqBill_WORKFLOW_AREA_STATUS_APPROVE = "2"; // 审核

	public static String DdSwitchseqBill_WORKFLOW_AREA_STATUS_EXEC = "3"; // 执行

	public static String DdSwitchseqBill_WORKFLOW_AREA_STATUS_OVER = "-1"; // 结束
	...
	public static String ddAccidentbrief_WORKFLOW_AREA_STATUS_NEW = "1"; // 新建

	public static String ddAccidentbrief_WORKFLOW_AREA_STATUS_MODIFY = "1m"; // 修改

	public static String ddAccidentbrief_WORKFLOW_AREA_STATUS_APPROVE = "2"; // 审批

	public static String ddAccidentbrief_WORKFLOW_AREA_STATUS_EXE = "3"; // 执行

	public static String ddAccidentbrief_WORKFLOW_AREA_STATUS_OVER = "-1"; // 结束
	...
	public static String ddCutofftitle_WORKFLOW_STATUS_NEW = "1";// 草稿

	public static String ddCutofftitle_WORKFLOW_STATUS_MODIFY = "1m";// 修改

	public static String ddCutofftitle_WORKFLOW_STATUS_APPROVE = "2";// 调度处长审批中

	public static String ddCutofftitle_WORKFLOW_STATUS_APPROVE_FH = "4";// 负荷专工审批中

	public static String ddCutofftitle_WORKFLOW_STATUS_RELEASE = "3";// 等待发布

	public static String ddCutofftitle_WORKFLOW_STATUS_END = "-1";// 结束
	...
	public static String ddMoutageplan_merge_success = "Y";// 合并成功，已合并
	...
	public static String ddMoutageplan_WORKFLOW_STATUS_NEW = "1";// 草稿

	// 驳回 修改
	public static String ddMoutageplan_WORKFLOW_STATUS_Modify = "1m";

	public static String ddMoutageplan_WORKFLOW_STATUS_CleanUp = "2";// 生技专工整理

	public static String ddMoutageplan_WORKFLOW_STATUS_SentResult = "3";// 停电计划专工分发

	public static String ddMoutageplan_WORKFLOW_STATUS_ApproveAndSend = "4";// 生技专工任务批准分发

	public static String ddMoutageplan_WORKFLOW_STATUS_CleanUpResult = "5";// 停电计划专工整理完成情况

	public static String ddMoutageplan_WORKFLOW_STATUS_end = "-1";// 结束
	...
	public static String DdWoutageplan_WORKFLOW_10DAYS_STATUS_NEW = "1"; // 新建

	public static String DdWoutageplan_WORKFLOW_10DAYS_STATUS_CleanUp = "2";// 生技专工整理

	public static String DdWoutageplan_WORKFLOW_10DAYS_STATUS_SentResult = "3";// 停电计划专工分发

	public static String DdWoutageplan_WORKFLOW_10DAYS_STATUS_ApproveAndSend = "4";// 生技专工任务批准

	public static String DdWoutageplan_WORKFLOW_10DAYS_STATUS_CleanUpResult = "5";// 停电计划专工整理完成情况
	
	public static String DdWoutageplan_WORKFLOW_10DAYS_STATUS_check = "6"; // 核准日计划

	public static String DdWoutageplan_WORKFLOW_10DAYS_STATUS_message = "7"; // 通知客户
	
	public static String DdWoutageplan_WORKFLOW_10DAYS_STATUS_Modify = "8";// 驳回 修改

	public static String DdWoutageplan_WORKFLOW_10DAYS_STATUS_OVER = "-1"; // 结束
	...
	public static String PowerRiskAnalysis_WORKFLOW_AREA_STATUS_NEW = "1"; // 新建

	public static String PowerRiskAnalysis_WORKFLOW_AREA_STATUS_APPROVE = "2";// 审批

	public static String PowerRiskAnalysis_WORKFLOW_AREA_STATUS_MODIFY = "1m";// 修改

	public static String PowerRiskAnalysis_WORKFLOW_AREA_STATUS_RELEASE = "3";// 发布

	public static String PowerRiskAnalysis_WORKFLOW_AREA_STATUS_END = "-1";// 结束
	...
	public static String DdEnsuringpsmanage_WORKFLOW_CITY_STATUS_NEW = "1"; // 新建

	public static String DdEnsuringpsmanage_WORKFLOW_CITY_STATUS_MODIFY = "1m"; // 修改

	public static String DdEnsuringpsmanage_WORKFLOW_CITY_STATUS_COURSIGN = "2"; // 会签

	public static String DdEnsuringpsmanage_WORKFLOW_CITY_STATUS_APPROVE = "3"; // 审核

	public static String DdEnsuringpsmanage_WORKFLOW_CITY_STATUS_SENT = "4"; // 下发

	public static String DdEnsuringpsmanage_WORKFLOW_CITY_STATUS_EXEC = "5"; // 执行

	public static String DdEnsuringpsmanage_WORKFLOW_CITY_STATUS_KEEPON = "6"; // 归档

	public static String DdEnsuringpsmanage_WORKFLOW_CITY_STATUS_OVER = "-1"; // 结束
	...
	public static String PowerRiskAnalysis_WORKFLOW_CITY_STATUS_NEW = "1"; // 新建

	public static String PowerRiskAnalysis_WORKFLOW_CITY_STATUS_APPROVE = "2";// 审批

	public static String PowerRiskAnalysis_WORKFLOW_CITY_STATUS_MODIFY = "1m";// 修改

	public static String PowerRiskAnalysis_WORKFLOW_CITY_STATUS_RELEASE = "3";// 发布

	public static String PowerRiskAnalysis_WORKFLOW_CITY_STATUS_END = "-1";// 结束
	...
	public static String DdSwitchseqBill_WORKFLOW_CITY_STOP_YES_NUM = "302"; // 终止flag

	public static String DdSwitchseqBill_WORKFLOW_CITY_EXEC_YES_NUM = "301"; // 执行flag

	public static String DdSwitchseqBill_WORKFLOW_CITY_EXEC_NO_NUM = "303";// 驳回

	// flag

	// 操作票流程状态

	public static String DdSwitchseqBill_WORKFLOW_CITY_STATUS_NEW = "1";// 新建

	public static String DdSwitchseqBill_WORKFLOW_CITY_STATUS_MODIFY = "101"; // 修改

	public static String DdSwitchseqBill_WORKFLOW_CITY_STATUS_APPROVE = "2"; // 审核

	public static String DdSwitchseqBill_WORKFLOW_CITY_STATUS_EXEC = "3"; // 执行

	public static String DdSwitchseqBill_WORKFLOW_CITY_STATUS_OVER = "-1"; // 结束
	...
	// 流程状态
	public static String ddAccidentbrief_WORKFLOW_CITY_STATUS_NEW = "1"; // 新建

	public static String ddAccidentbrief_WORKFLOW_CITY_STATUS_MODIFY = "1m"; // 修改

	public static String ddAccidentbrief_WORKFLOW_CITY_STATUS_APPROVE = "2"; // 审批

	public static String ddAccidentbrief_WORKFLOW_CITY_STATUS_EXE = "3"; // 执行

	public static String ddAccidentbrief_WORKFLOW_CITY_STATUS_OVER = "-1"; // 结束
	...
	public static String DdDoutageplan_WORKFLOW_CITY_STATUS_check = "7"; // 核准日计划

	public static String DdDoutageplan_WORKFLOW_CITY_STATUS_message = "8"; // 通知客户
	...
	public static String DdDoutageplan_WORKFLOW_CITY_STATUS_APPROVE_TRANSIT_YES = "401"; // 市调审批通过

	public static String DdDoutageplan_WORKFLOW_CITY_STATUS_APPROVE_TRANSIT_NO = "402";// 市调审批驳回


	public static String DdDoutageplan_WORKFLOW_CITY_STATUS_NEW = "1"; // 新建

	public static String DdDoutageplan_WORKFLOW_CITY_STATUS_ARRAY = "2"; // 整理审核

	public static String DdDoutageplan_WORKFLOW_CITY_STATUS_COURSIGN = "3"; // 会签

	public static String DdDoutageplan_WORKFLOW_CITY_STATUS_APPROVE = "4"; // 审核

	public static String DdDoutageplan_WORKFLOW_CITY_STATUS_SENT = "5"; // 下发

	public static String DdDoutageplan_WORKFLOW_CITY_STATUS_EXEC = "6"; // 执行

	public static String DdDoutageplan_WORKFLOW_CITY_STATUS_KEEPON = "7"; // 归档

	public static String DdDoutageplan_WORKFLOW_CITY_STATUS_OVER = "-1"; // 结束
