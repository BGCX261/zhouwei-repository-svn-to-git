 ...
 * @date
 */
public class StdUnfinishreasonDto extends DictionaryBaseDto implements Serializable {
    
	public StdUnfinishreasonDto() {
    }
	
          private String reason2; //未完成原因2
	      private String freason1id; //未完成原因1分类
	      private int version; //数据库版本控制
	      private java.util.Collection fddmoutageplan3; //未完成原因id
	      private java.util.Collection fdddoutageplan5; //未完成原因id
