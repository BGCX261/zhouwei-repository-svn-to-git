 ...
 * @date
 */
public class StdManufacturerDto extends DictionaryBaseDto implements Serializable {
    
	public StdManufacturerDto() {
    }
	      ...
	      private java.util.Collection fetsequipment3; //厂家编码
	      private java.util.Collection fetsequipment4; //厂家编码
