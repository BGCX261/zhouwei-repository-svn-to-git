...
request.setAttribute("extWheres","t.zddsasusprecord3.fid='"+CurGroupLogNO+"'");
%>
<P> 
...
<jhop:grid 	id="mygrid"
      ...
      busName="DdClassondutylogDto2"
      subName="128199523071635200"
      pageItems="10"
      listType="3"
      listKind="101"
      entityName="DdSasusprecord"
      isDisplaySet="1"
      isQuerySet="1"
      isPageSet="1"
      isOutputSet="1"
      queryPath="/ddClassondutylog.do?method=standGridQuery2&extWheres=${extWheres}">
</jhop:grid>