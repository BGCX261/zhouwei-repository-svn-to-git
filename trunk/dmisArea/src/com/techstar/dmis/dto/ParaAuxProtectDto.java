 ...
 * @date
 */
public class ParaAuxProtectDto  implements Serializable {
    
	public ParaAuxProtectDto() {
    }
	      ...
	      private com.techstar.dmis.dto.EtsEquipmentDto zparaauxprotect2; //设备ID
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparaauxprotect2(com.techstar.dmis.dto.EtsEquipmentDto zparaauxprotect2){
        this.zparaauxprotect2=zparaauxprotect2;
    }
	   public com.techstar.dmis.dto.EtsEquipmentDto getZparaauxprotect2(){
