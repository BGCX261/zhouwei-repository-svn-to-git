...
<%
	...
	String strMainId="SOndutyNo='"+mainId+"'";
	String url="/zdhOpexaminelist.do?method=extStandGridQuery&extWheres="+strMainId;
...
<%-- 创建弹出窗口，并传递参数 --%>
<jhop:grid 	id="mygrid"
      pageId="standGridPage3"
      busName="ZdhOpexaminelistDto"
      subName="128201273344171456"
      pageItems="10"
      listType="3"
      listKind="101"
      entityName="ZdhOpexaminelist"
      isDisplaySet="1"
      isQuerySet="1"
      isPageSet="1"
      isOutputSet="1"
