...
public class DdWoutageplanServiceImpl implements IDdWoutageplanService {
   ...
   private IBaseJdbcDao baseJdbcDao ;
	 ...
	 public void setDdRepairdetailDao
	    (IDdRepairdetailDao ddRepairdetailDao) {
   ...
   public QueryListObj listDdWoutageplan() {
		...
		if (obj.getElemList() != null) {
			List dtos = (List) BeanHelper.buildBeans(DdWoutageplanDto.class, obj
					.getElemList());
  ...
  /**
   ...
   public QueryListObj listDdRepairdetail() {
		...
		if (obj.getElemList() != null) {
			List dtos = (List) BeanHelper.buildBeans(DdRepairdetailDto.class, obj
					.getElemList());
			obj.setElemList(dtos);
		}
		return obj;
