 ...
 * @date
 */
public class ParaCAPBank implements Serializable {
	...
	public ParaCAPBank() {
    		 ...
    		 private int fcapvalue;//电容值(μF)
					 ...
					 private com.techstar.dmis.entity.EtsEquipment zparacapbank2;
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparacapbank2(com.techstar.dmis.entity.EtsEquipment zparacapbank2){
        this.zparacapbank2=zparacapbank2;
    }
	   public com.techstar.dmis.entity.EtsEquipment getZparacapbank2(){
