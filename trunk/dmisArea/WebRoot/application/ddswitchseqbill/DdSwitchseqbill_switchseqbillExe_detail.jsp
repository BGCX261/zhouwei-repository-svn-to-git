...
<input type="hidden" name="ddSwitchseqbillDto.fcomputerno"
			...
			<jhop:ctrlgroup
				...
				<img name='save'
					...
					onClick="var parentid = document.getElementById('ddSwitchseqbillDto.fcomputerno').value;saveDTOS('<%=request.getContextPath()%>/ddSwitchseqbill.do?method=saveSeqbilldetailGrid',iGrid.mygrid,parentid,false,'','')">
				...
				<tr>
					<td align="center" height="150">
						<iframe name="iGrid" frameborder='0' width="100%" 　scrolling="no"
							height="150"
							src='<%=request.getContextPath()%>/application/ddswitchseqbill/DdSwitchseqbill_switchseqbillsteps_grid_exe.jsp?fcomputerno=${ddSwitchseqbillForm.ddSwitchseqbillDto.fcomputerno}'></iframe>
