 ...
 * @date
 */
public class ParaSeverDto  implements Serializable {
	...
	public ParaSeverDto() {
	      ...
	      private com.techstar.dmis.dto.EtsEquipmentDto zparasever2; //设备ID
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparasever2(com.techstar.dmis.dto.EtsEquipmentDto zparasever2){
        this.zparasever2=zparasever2;
    }
	   public com.techstar.dmis.dto.EtsEquipmentDto getZparasever2(){
      return zparasever2;
    }
