 ...
 */
public class TransZdhAutoondutylogDto  implements Serializable {
    
    private static final long serialVersionUID = 1L;
    public TransZdhAutoondutylogDto() {
    }
   ...
   /**
     ...
     */
      ...
      return logdate;
             ...
             public void setSuccessiontime(java.sql.Date successiontime){
        this.successiontime=successiontime;
    }
	   public java.sql.Date getSuccessiontime(){
      return successiontime;
    }
             public void setHandovertime(java.sql.Date handovertime){
        this.handovertime=handovertime;
    }
	   public java.sql.Date getHandovertime(){
      return handovertime;
    }
