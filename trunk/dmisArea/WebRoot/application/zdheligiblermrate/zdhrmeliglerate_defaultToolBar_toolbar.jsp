...
<script type="text/javascript">
	function deleteData(itemId,itemValue){
		...
		if(sign){
			if(version != null && version != "" && primaryId != null && primaryId != ""){
				...
				var url			= "<%=request.getContextPath()%>/zdhEligiblermrate.do?method=delete";
	 ...
	 */
	function preRow(){
		operToolbarRow("iframe1","zdhEligiblermrate","previous");
	}
	/**
	 * 下一条操作
	 */
	function nextRow(){
		operToolbarRow("iframe1","zdhEligiblermrate","next");
	}
</script>