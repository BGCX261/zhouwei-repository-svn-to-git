 ...
 * @date
 */
public class ParaParallReactorDto  implements Serializable {
    
	public ParaParallReactorDto() {
    }
	      ...
	      private com.techstar.dmis.dto.EtsEquipmentDto zparaparallreactor2; //设备ID
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparaparallreactor2(com.techstar.dmis.dto.EtsEquipmentDto zparaparallreactor2){
        this.zparaparallreactor2=zparaparallreactor2;
    }
	   public com.techstar.dmis.dto.EtsEquipmentDto getZparaparallreactor2(){
