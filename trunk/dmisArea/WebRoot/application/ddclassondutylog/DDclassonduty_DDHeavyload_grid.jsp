...
System.out.println("fid="+CurGroupLogNO);
request.setAttribute("extWheres","t.zddhloadrecord4.fid='"+CurGroupLogNO+"'");
%>
<br>
<div id='mygrid'></div>
<br>
...
<jhop:grid 	id="mygrid"
      ...
      busName="DdClassondutylogDto1"
      subName="128199632539131256"
      pageItems="30"
      listType="3"
      listKind="101"
      entityName="DdHloadrecord"
      isDisplaySet="1"
      isQuerySet="1"
      isPageSet="1"
      isOutputSet="1"
      queryPath="/ddClassondutylog.do?method=standGridQuery1&extWheres=${extWheres}">
</jhop:grid>
