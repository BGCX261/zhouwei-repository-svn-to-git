 ...
 * @date
 */
public class FsLfparalistDto  implements Serializable {
    
	public FsLfparalistDto() {
    }
	      ...
	      private com.techstar.dmis.dto.StdLfroundDto zfslfparalist3; //低频定值轮次
   ...
   /**
     ...
     */
      ...
      return ffsloaddatalist1;
           ...
           public void setZfslfparalist3(com.techstar.dmis.dto.StdLfroundDto zfslfparalist3){
        this.zfslfparalist3=zfslfparalist3;
    }
	   public com.techstar.dmis.dto.StdLfroundDto getZfslfparalist3(){
