 ...
 * @date
 */
public class DdDoutageplan implements Serializable {
    
	public DdDoutageplan() {
    }
    		 private String fmanualno;//手工编号
					 ...
					 private byte[] faddipicture;//附图
					 private byte[] funmeasureannex;//反措附件
					 ...
					 private java.sql.Timestamp csendtime;//中调下令时间
					 private String creturncontent;//向中调交令内容
					 private String csender;//中调下令人
					 private String creceiver2;//市调接令人
					 private String cmdcontent;//下令内容
					 private String creturner;//向中调回令人
					 private java.sql.Timestamp creturntime;//向中调回令时间
					 private String creceiver1;//中调收令人
					 private String cancelcode;//取消原因代码
					 ...
					 private String fabolishreason;//取消原因
					 private String fdayplanno;//日计划编号
					 private int version;//数据库版本控制
					 private String stampid;
					 private java.util.Collection fddrepairdetail2;
	    			 private java.util.Collection fdddayplandelaylist1;
	    			 private java.util.Collection fdddayplanexcutelist1;
	    			 private java.util.Collection fddfsmodechangelist4;
	    			 private java.util.Collection fdayplancoopraterel1;
	    			 private java.util.Collection fdddayplanfixvaluerel2;
	    			 private java.util.Collection fzdhopexaminelist6;
   ...
   /**
     ...
     */
      ...
      return fremark;
           ...
           public void setFaddipicture(byte[] faddipicture){
        this.faddipicture=faddipicture;
    }
	   public byte[] getFaddipicture(){
      return faddipicture;
    }
           public void setFunmeasureannex(byte[] funmeasureannex){
        this.funmeasureannex=funmeasureannex;
    }
	   public byte[] getFunmeasureannex(){
      ...
      return csendtime;
           ...
           public void setCreturncontent(String creturncontent){
        this.creturncontent=creturncontent;
    }
	   public String getCreturncontent(){
      return creturncontent;
    }
      ...
      return csender;
           ...
           public void setCreceiver2(String creceiver2){
        this.creceiver2=creceiver2;
    }
	   public String getCreceiver2(){
      return creceiver2;
    }
      ...
      return cmdcontent;
           ...
           public void setCreturner(String creturner){
        this.creturner=creturner;
    }
	   public String getCreturner(){
      return creturner;
    }
           public void setCreturntime(java.sql.Timestamp creturntime){
        this.creturntime=creturntime;
    }
	   public java.sql.Timestamp getCreturntime(){
      return creturntime;
    }
           public void setCreceiver1(String creceiver1){
        this.creceiver1=creceiver1;
    }
	   public String getCreceiver1(){
      return creceiver1;
    }
      ...
      return fvoltage;
           ...
           public void setFabolishreason(String fabolishreason){
        this.fabolishreason=fabolishreason;
    }
	   public String getFabolishreason(){
      return fabolishreason;
    }
