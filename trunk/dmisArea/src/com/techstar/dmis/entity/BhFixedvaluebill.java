 ...
 * @date
 */
public class BhFixedvaluebill implements Serializable {
    
	public BhFixedvaluebill() {
    }
    		 private java.sql.Date fixvaluedate;//出单日期
					 ...
					 private byte[] fixvalueoriginal;//定值单原件
					 ...
					 private java.util.Collection fbhfixedvaluebilldetail1;
   ...
   /**
     ...
     */
      ...
      return eqpid;
           ...
           public void setFixvalueoriginal(byte[] fixvalueoriginal){
        this.fixvalueoriginal=fixvalueoriginal;
    }
	   public byte[] getFixvalueoriginal(){
