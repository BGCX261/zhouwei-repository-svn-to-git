 ...
 * @date
 */
public class StdStation implements Serializable {
	...
	public StdStation() {
    		 ...
    		 private String stationname;//变电站名称
					 ...
					 private java.util.Collection fzdhtransrecord1;
	    			 private java.util.Collection fddhpoweroperaterrd2;
	    			 private java.util.Collection fddwaterheight2;
	    			 private java.util.Collection fbhasregulate2;
	    			 private java.util.Collection fddpowerchangrecord6;
	    			 private java.util.Collection fzdhrmrec4;
