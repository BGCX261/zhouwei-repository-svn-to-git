 ...
 * @date
 */
public class BhAsregulateDto  implements Serializable {
    
	public BhAsregulateDto() {
    }
	      ...
	      private byte[] asregulateoriginal; //自投规程原件
	      private byte[] runmodedigram; //运行方式图
	      ...
	      private com.techstar.dmis.dto.StdStationDto zbhasregulate2; //变电站编号
   ...
   /**
     ...
     */
      ...
      return fbhasregulatedetail3;
           ...
           public void setZbhasregulate2(com.techstar.dmis.dto.StdStationDto zbhasregulate2){
        this.zbhasregulate2=zbhasregulate2;
    }
	   public com.techstar.dmis.dto.StdStationDto getZbhasregulate2(){
