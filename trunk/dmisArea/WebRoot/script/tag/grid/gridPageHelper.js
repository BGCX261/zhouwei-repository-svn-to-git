 ...
 *  分页主体函数
 */
function pageHelper(pageObj,cPage,pSize,tCount,nCount){
	/**
	 *  每页显示数据条数
	 */
	this.pageSize = pSize;
...
pageHelper.prototype.getFirstPage = function(){
	var firstStr = "";
	var srcTop = "/themes/themes1/images/main/arrowleft3_2.gif";
	var alt    = "首页";
	if(parseInt(this.currPage) == 1){
...
pageHelper.prototype.getPrePage = function(){
	var preStr  = "";
	var srcPre  = "/themes/themes1/images/main/arrowleft3_1.gif";
	var alt     = "上一页";
	if(this.hasPre){
...
pageHelper.prototype.getNextPage = function(){
	var nextStr  = "";
	var srcNext  = "/themes/themes1/images/main/arrowright3_1.gif";
	var alt      = "下一页";
	if(this.hasNext){
...
pageHelper.prototype.getEndPage = function(){
	var endStr = "";
	var srcEnd = "/themes/themes1/images/main/arrowright3_2.gif";
	var alt    = "末页";
	if(parseInt(this.currPage) == parseInt(this.totalPageCount)){
...
function submitDataByGrid(pageStr,pageSize){
	 if(pageStr){
		var filterParams = document.all.filterStr.value;
	 	createGrid('','0','',pageStr+'^'+pageSize,'','',filterParams,'');
