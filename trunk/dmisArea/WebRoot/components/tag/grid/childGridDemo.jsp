...
<jhop:grid 	id="mygrid"  
			...
			isTotalRow="0" 
			isOperater="1" 
			listBox="print_time#5,begin_date#6^1@1@3,end_date#6^1@2@6,custom_id#3^type=zzmm@@@parentId=,custom_name#2^src=SQDW" 
			...
			queryPath="/ui.do?method=detailchildGrid&parentid=${parentid}"> 
</jhop:grid>
<br>
<br>
</body>	
