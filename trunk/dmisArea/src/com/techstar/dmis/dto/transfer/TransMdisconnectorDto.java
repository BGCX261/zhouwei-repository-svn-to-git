...
/**
 * Domain classe for 隔离开关
 * This classe is based on ValueObject Pattern
 */
public class TransMdisconnectorDto  implements Serializable {
    
    private static final long serialVersionUID = 1L;
    public TransMdisconnectorDto() {
    }
          ...
          private String fnormalopen; //正常开合状态
   ...
   /**
     ...
     */
      ...
      return fmemberof_equipmentcontainer;
             ...
             public void setFnormalopen(String fnormalopen){
        this.fnormalopen=fnormalopen;
    }
	   public String getFnormalopen(){
      return fnormalopen;
    }
