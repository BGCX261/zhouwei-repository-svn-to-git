 ...
 * @date
 */
public class DdWaterproofplan implements Serializable {
    
	public DdWaterproofplan() {
    }
    		 private String fapplyuser;//申请人
					 ...
					 private com.techstar.dmis.entity.DdClassondutylog zddwaterproofplan2;
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZddwaterproofplan2(com.techstar.dmis.entity.DdClassondutylog zddwaterproofplan2){
        this.zddwaterproofplan2=zddwaterproofplan2;
    }
	   public com.techstar.dmis.entity.DdClassondutylog getZddwaterproofplan2(){
