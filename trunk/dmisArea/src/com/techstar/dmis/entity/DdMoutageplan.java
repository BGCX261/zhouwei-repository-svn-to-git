 ...
 * @date
 */
public class DdMoutageplan implements Serializable {
    
	public DdMoutageplan() {
    }
    		 private String fstationname;//变电站
					 ...
					 private byte[] feqpcontent;//设备参数信息
					 ...
					 private String funfinishreasonid;//未完成原因id
					 private String monthplantype;//计划性质
					 private String fmonthplanno;//月计划编号
					 private int version;//数据库版本控制
					 private java.util.Collection fddrepairdetail1;
	    			 private java.util.Collection fddpremethod5;
	    			 
	    			 private String fmonthplancode;
   ...
   /**
	...
	public String getFmonthplancode() {
		return fmonthplancode;
	}
	public void setFmonthplancode(String fmonthplancode) {
		this.fmonthplancode = fmonthplancode;
	}
