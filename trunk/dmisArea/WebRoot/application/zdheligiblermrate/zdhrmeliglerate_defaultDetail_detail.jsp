	...
	<body>
		...
		<form name="zdhEligiblermrateForm" action="" method="post">
			...
			<table class="detailmain" cellspacing="0" cellpadding="0">
				...
				value="${zdhEligiblermrateForm.zdhEligiblermrateDto.sys_isvalid}">
							<%--数据所属单位--%>
	   ...
	   <tr>
				 ...
				 <bean:message key="object.zdhEligiblermrateDto.sys_filltime"/><%--填写时间--%></td>
			  			   ...
			  			   <td height="23" width="30%" >
				 <input id="zdhEligiblermrateDto.sys_filltime" name="zdhEligiblermrateDto.sys_filltime" type="text" value="${zdhEligiblermrateForm.zdhEligiblermrateDto.sys_filltime}" size="20"  readonly/>
			   </td>
			  	<td height="23" class="tab_0" width="20%">
				 ...
				 <input id="zdhEligiblermrateDto.sys_dataowner" name="zdhEligiblermrateDto.sys_dataowner" type="text" value="${zdhEligiblermrateForm.zdhEligiblermrateDto.sys_dataowner}" size="10"  readonly/>
							...
							<!--tr>
								<td height="23" class="tab_0" width="15%">
									<bean:message key="object.zdhEligiblermrateDto.sys_isvalid" />
									<%--是否有效字段--%>
								</td>

								<td height="23" width="35%">
									<input id="zdhEligiblermrateDto.sys_isvalid"
										name="zdhEligiblermrateDto.sys_isvalid" type="text"
										value="<c:out value="${zdhEligiblermrateForm.zdhEligiblermrateDto.sys_isvalid}"/>"
										size="10" <%=readonly%> />
								</td>
								<td height="23" class="tab_0" width="15%">
									<bean:message
										key="object.zdhEligiblermrateDto.zzdheligiblermrate1.ondutyno" />
									<%--交接班记录编号--%>
								</td>

								<td height="23" width="35%">
									<input id="zdhEligiblermrateDto.zzdheligiblermrate1.ondutyno"
										name="zdhEligiblermrateDto.zzdheligiblermrate1.ondutyno"
										type="text"
										value="<c:out value="${zdhEligiblermrateForm.zdhEligiblermrateDto.zzdheligiblermrate1.ondutyno}"/>"
										size="10" readonly />
								</td>
