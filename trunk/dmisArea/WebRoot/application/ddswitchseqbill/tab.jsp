...
<!--
   	...
   	function onClick1(){
		document.all.iframe1.src = "<%=request.getContextPath()%>/application/ddswitchseqbill/grid.jsp";
	}
...
<jhop:labelgroup height="530" labelHead="调度操作票浏览,调度操作票详情" scroll="auto,auto"> </jhop:labelgroup>
