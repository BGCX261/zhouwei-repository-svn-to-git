 ...
 */
public class TransEtsEquipmentDto  implements Serializable {
    
    private static final long serialVersionUID = 1L;
    public TransEtsEquipmentDto() {
    }
          ...
          private java.util.Collection fddhloadrecord6; //设备ID
          private java.util.Collection fzdhworkbill4; //设备ID
          private java.util.Collection feqpattachment2; //设备ID
          private String trans_zetsequipment3; //生产厂家ID
          private String trans_zetsequipment5; //运行单位ID
          private String trans_zetsequipment6; //维护单位ID
          private String trans_zetsequipment4; //购货厂家ID
          private String trans_zetsequipment7; //类型ID
          private String trans_zetsequipment2; //所属间隔ID
   ...
   /**
     ...
     */
      ...
      return feqpattachment2;
             ...
             public void setTrans_zetsequipment3(String trans_zetsequipment3){
        this.trans_zetsequipment3=trans_zetsequipment3;
    }
	   public String getTrans_zetsequipment3(){
      return trans_zetsequipment3;
    }
             public void setTrans_zetsequipment5(String trans_zetsequipment5){
        this.trans_zetsequipment5=trans_zetsequipment5;
    }
	   public String getTrans_zetsequipment5(){
      return trans_zetsequipment5;
    }
             public void setTrans_zetsequipment6(String trans_zetsequipment6){
        this.trans_zetsequipment6=trans_zetsequipment6;
    }
	   public String getTrans_zetsequipment6(){
      return trans_zetsequipment6;
    }
             public void setTrans_zetsequipment4(String trans_zetsequipment4){
        this.trans_zetsequipment4=trans_zetsequipment4;
    }
	   public String getTrans_zetsequipment4(){
      return trans_zetsequipment4;
    }
             public void setTrans_zetsequipment7(String trans_zetsequipment7){
        this.trans_zetsequipment7=trans_zetsequipment7;
    }
	   public String getTrans_zetsequipment7(){
      return trans_zetsequipment7;
    }
             public void setTrans_zetsequipment2(String trans_zetsequipment2){
        this.trans_zetsequipment2=trans_zetsequipment2;
    }
	   public String getTrans_zetsequipment2(){
      return trans_zetsequipment2;
    }
