...
<jhop:grid 	id="mygrid"
      ...
      listBox="fgivetime#5^,fsummittime#5^,fgiver#108^showfgiver,faccepter#108^showfaccepter,fsummiter#108^showfsummiter,fstepstatus#101^已执行@取消此行" 
       editType="fstep#ro,fstationname#ro,fcontent#ro"
