 ...
 * @date
 */
public class FsLoaddatalistDto  implements Serializable {
    
	public FsLoaddatalistDto() {
    }
	      ...
	      private com.techstar.dmis.dto.FsLfparalistDto zfsloaddatalist1; //线路资料编号
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZfsloaddatalist1(com.techstar.dmis.dto.FsLfparalistDto zfsloaddatalist1){
        this.zfsloaddatalist1=zfsloaddatalist1;
    }
	   public com.techstar.dmis.dto.FsLfparalistDto getZfsloaddatalist1(){
      return zfsloaddatalist1;
    }
