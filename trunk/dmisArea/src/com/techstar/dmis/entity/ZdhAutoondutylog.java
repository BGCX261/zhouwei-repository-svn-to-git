 ...
 * @date
 */
public class ZdhAutoondutylog implements Serializable {
    
	public ZdhAutoondutylog() {
    }
             ...
             java.sql.Timestamp handovertime; //交班时间
					 ...
					 private java.util.Collection fzdhworkbill2;
	    			 private java.util.Collection fzdhmachineworklist1;
	    			 private java.util.Collection fzdhrmrec1;
	    			 private java.util.Collection fzdhrsrecord2;
	    			 private java.util.Collection fzdhcharalterrecord2;
	    			 private java.util.Collection fzdhfaultlist7;
	    			 private java.util.Collection fzdhtransrecord3;
	    			 private java.util.Collection fzdhopexaminelist5;
