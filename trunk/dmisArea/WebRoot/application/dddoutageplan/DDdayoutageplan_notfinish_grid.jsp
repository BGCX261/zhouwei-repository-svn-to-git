...
<%-- 创建弹出窗口，并传递参数 --%>
<jhop:grid id="mygrid" pageId="standGridPage" busName="DdDoutageplanDto"
	subName="128197051371530608" pageItems="30" listType="3" listKind="101"
	entityName="DdDoutageplan" isDisplaySet="0" isQuerySet="0"
	isPageSet="1" isOutputSet="0"
	queryPath="/ddDoutageplan.do?method=getNotFinishDDD">
</jhop:grid>
