...
dhtmlXToolbarObject.prototype._parseXMLTree = function (that, node) 
{
	...
	for (var i = 0; i < node.childNodes.length; i++) {
		...
		if (localItem.nodeType == 1) {
			...
			else if (localItem.tagName == "ImgDivider")
			{
				var imid   = localItem.getAttribute("id");
				var src    = localItem.getAttribute("src");
				var height = localItem.getAttribute("height");
				var width  = localItem.getAttribute("width");
				that.addItem(new dhtmlXToolbarDividerImgXObject(src,imid,height,width));
			}
			else if(localItem.tagName == "TextDivider")
			{
				var imid   = localItem.getAttribute("id");
				var text   = localItem.getAttribute("text");
				var height = localItem.getAttribute("height");
				var width  = localItem.getAttribute("width");
				that.addItem(new dhtmlXToolbarDividerTextXObject(imid,text,height,width));	
			}
			else if(localItem.tagName == "InputText")
			{
				var imid   = localItem.getAttribute("id");
				var size   = localItem.getAttribute("size");
				that.addItem(new dhtmlXToolbarInputTextXObject(imid,size));
			}
			else 
			{
				if (TempNode) 
...
dhtmlXToolbarObject.prototype._create_self = function () {
	...
	//div.innerHTML = "<table cellpadding=\"0\" cellspacing=\"1\" class=\"" + this.tableCSS + "\" style=\"display:none\" width=\"" + this.width + "\" height=\"" + this.height + "\"><tbody>" + "<tr>" + "<td width=\"" + (this.gecko ? 5 : 3) + "px\"><div class=\"toolbarHandle\">&nbsp;</div></td>" + "<td class=\"" + this.titleCSS + "\" style=\"display:none\">" + this.name + "</td>" + "<td></td>" + "<td align=\"right\" width=\"100%\" class=\"" + this.titleCSS + "\" style=\"display:none\">" + this.name + "</td>" + "<td></td>" + "</tr></tbody></table>";
	div.innerHTML = "<table cellpadding=\"0\" cellspacing=\"1\" class=\"" + this.tableCSS + "\" style=\"display:none\" width=\"" + this.width + "\" height=\"" + this.height + "\">"
					+ "	<tbody>"
					+ "		<tr>"
					+ "			<td width=\"" + (this.gecko ? 5 : 3) + "px\"><div class=\"toolbarHandle\">&nbsp;</div></td>"
					+ "			<td class=\"" + this.titleCSS + "\" style=\"display:none\">" + this.name + "222</td>"
					+ "			<td></td>"
					+ "			<td align=\"right\" class=\"" + this.titleCSS + "\" style=\"display:none\">" + this.name + "</td>"
					+ "			<td></td>"
					+ "		</tr>"
					+ "	</tbody>"
					+ "</table>";
...
dhtmlXToolbarObject.prototype._create_self_vertical = function () {
	...
	var div = document.createElement("div");
	div.innerHTML = "<table cellpadding=\"0\" cellspacing=\"1\" class=\"" + this.tableCSS + "\" style=\"display:none\" width=\"" + this.width + "\" height=\"" + this.height + "\"><tbody>" + "<tr><td heigth=\"" + (this.gecko ? 5 : 3) + "px\"><div class=\"vtoolbarHandle\" style=\"height: 3px; width:100%; overflow:hidden\"></div></td></tr>" + "<tr><td height=\"100%\" class=\"" + this.titleCSS + "\" style=\"display:none\">" + this.name + "</td></tr>" + "<tr><td></td></tr>" + "<tr><td align=\"right\" height=\"100%\" class=\"" + this.titleCSS + "\" style=\"display:none\">" + this.name + "</td></tr>" + "<tr><td></td></tr>" + "</tbody></table>";
	var table = div.childNodes[0];
	table.onselectstart = this.badDummy;
	table.setAttribute("UNSELECTABLE", "on");
	this.topNod = table;
...
/**  
          ...
          *     @topic: 0  
          */
function dhtmlXToolbarDividerImgXObject(src,id,height,width) 
{
	this.topNod = 0;
	if (id) {
		this.id = id;
	...
	td = document.createElement("td");
	this.topNod = td;
	//this.MM_showMenu1 = MM_showMenu;
	td.align = "center";
	td.style.paddingRight = "2";
	td.style.paddingLeft  = "2";
	td.width = "4px";
	td.innerHTML = "<div height='"+height+"' width='"+width+"'><img id='"+id+"' border='0' src='"+src+"'></div\t>";
	if (!document.all) 
	{
		td.childNodes[0].style.width = "0px";
		td.style.padding = "0 0 0 0";
...
dhtmlXToolbarDividerImgXObject.prototype = new dhtmlXButtonPrototypeObject;
//dhtmlXToolbarDividerImgXObject.prototype = new Menu;
...
dhtmlXToolbarDividerImgXObject.prototype._onmouseoutX = function (e) 
{
...
dhtmlXToolbarDividerImgXObject.prototype._onmouseoverX = function (e) 
{	
...
/**  
          ...
          *     @topic: 0  
          */
function dhtmlXToolbarDividerDivXObject(src,id,height,width) 
{
	this.topNod = 0;
	if (id) {
		this.id = id;
	...
	td.style.paddingLeft  = "2";
	td.width = "4px";
	td.innerHTML = "<div id='"+id+"' height='"+height+"' width='"+width+"'></div\t>";
	if (!document.all) 
	{
		td.childNodes[0].style.width = "0px";
		td.style.padding = "0 0 0 0";
...
dhtmlXToolbarDividerDivXObject.prototype = new dhtmlXButtonPrototypeObject;
//dhtmlXToolbarDividerImgXObject.prototype = new Menu;
...
dhtmlXToolbarDividerDivXObject.prototype._onmouseoutX = function (e) 
{
	if(event.srcElement.tagName == "IMG")
	{
	}
...
dhtmlXToolbarDividerDivXObject.prototype._onmouseoverX = function (e) 
{	
	var id = event.srcElement.id;
	if(id.indexOf("div") == -1)
	{
...
/**  
          ...
          *     @topic: 0  
          */
function dhtmlXToolbarDividerTextXObject(id,text,height,width) 
{
	this.topNod = 0;
	if (id) {
		this.id = id;
	...
	td.width = "10px";
	if(text)
		td.innerHTML = "<div >"+text+"</div\t>"; //class='p1'
	else
...
dhtmlXToolbarDividerTextXObject.prototype = new dhtmlXButtonPrototypeObject;
/*------------------------------------------------------------------------------
								End of hDivider object
--------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------
...
/**  
          ...
          *     @topic: 0  
          */
function dhtmlXToolbarInputTextXObject(id,size) 
{
	this.topNod = 0;
	if (id) {
		this.id = id;
	...
	td.style.paddingLeft  = "2";
	td.width = "125px";
	td.innerHTML = "<div><input type='text' id='"+id+"' name='"+id+"' class='input' size='"+size+"'></div\t>";
	if (!document.all) 
	{
		td.childNodes[0].style.width = "0px";
		td.style.padding = "0 0 0 0";
...
dhtmlXToolbarInputTextXObject.prototype = new dhtmlXButtonPrototypeObject;
/*------------------------------------------------------------------------------
								End of hDivider object
--------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------
