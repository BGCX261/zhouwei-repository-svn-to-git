 ...
 * @date
 */
public class ParaAuxTRF implements Serializable {
	...
	public ParaAuxTRF() {
    		 ...
    		 private String fvoltageratio;//电压比_kV
					 ...
					 private com.techstar.dmis.entity.EtsEquipment zparaauxtrf2;
   ...
   /**
     ...
     */
      ...
      return version;
           ...
           public void setZparaauxtrf2(com.techstar.dmis.entity.EtsEquipment zparaauxtrf2){
        this.zparaauxtrf2=zparaauxtrf2;
    }
	   public com.techstar.dmis.entity.EtsEquipment getZparaauxtrf2(){
      return zparaauxtrf2;
    }
