...
request.setAttribute("extWheres","t.zddwaterproofplan2.fid='"+CurGroupLogNO+"'");
%>
<br>
<div id='mygrid'></div>
<br>
...
<jhop:grid 	id="mygrid"
      ...
      busName="DdClassondutylogDto7"
      subName="128199706184953012"
      pageItems="10"
      listType="3"
      listKind="101"
      entityName="DdWaterproofplan"
      isDisplaySet="1"
      isQuerySet="1"
      isPageSet="1"
      isOutputSet="1"
      queryPath="/ddClassondutylog.do?method=standGridQuery7&extWheres=${extWheres}">
</jhop:grid>